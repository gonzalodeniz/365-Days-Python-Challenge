...
def test_cuenta_numeros_matriz() -> None:
...
def test_sustituye_repetidos_por_cero() -> None:
...
def test_calcula_elementos_sin_repetir() -> None:
...
def test_reemplaza_repetidos_por_ceros() -> None:
